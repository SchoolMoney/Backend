from repository import child_repository
import src.SQL as SQL

from src.Model.ClassGroup import AddClassGroup, ChangeClassGroupCashier, UpdateClassGroup
...
async def update(
    ...
    class_group_with_same_name = await class_group_repository.get_by_name(sql_session, update_data.name)
    ...
    user_group_role = await parent_group_role_repository.get(sql_session, class_group_id, user_parent_profile.id)
